        ...
        <div className=" text-center  w-80">
          ...
          <div className=" -mt-8">
            ...
            <div className="justify-center">
              <button className="btn  bg-[#00ADBB] text-white mt-4">Buy Now</button>
            </div>
          </div>
        </div>
        <div className=" text-center  w-80">
          ...
          <div className=" -mt-8">
            ...
            <div className="justify-center">
              <button className="btn  bg-[#FF5D3E] text-white mt-4">Find Rental</button>
            </div>
          </div>
        </div>
        <div className=" text-center w-80">
          ...
          <div className=" -mt-8">
            ...
            <div className="justify-center">
              <button className="btn  bg-[#FF8c68] text-white mt-4">Learn More</button>
            </div>
          </div>
        </div>
      </div>
